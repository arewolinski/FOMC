...
#         if(word == "roll." and last_word == "the" and two_ago_word == "Call"):
...
#         # This boolean expression checks if we come across a second roll call instance
#         if(after_start_point and (not before_end_point) and word == "roll." and last_word == "the" and two_ago_word == "Call"):

#             before_end_point = True

#             #Creating a line break between instances of "Call the roll."
#             output_string += "\n" + "\n"
...
#Example usage:
# path_to_pdf = 'main.rice/files/Transcripts Raw pdf/1_1987_transcript.pdf'
